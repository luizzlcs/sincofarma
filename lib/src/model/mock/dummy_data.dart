...
class DummyData {
  var data = [
    DummyModel(
      ...
      objective:
          'Lorem ipsum dolor sit amet. Et fugit reprehenderit ut quisquam similique aut velit quas et quia nesciunt. Aut labore veritatis in doloremque sunt et ipsam quas qui magnam reprehenderit et ducimus voluptatem ad magnam incidunt.',
      amounts: 'R\$ 890,00',
      theoryAndTechnique:
          'Lorem ipsum dolor sit amet. Quo asperiores quod et veritatis vero sit accusantium alias est omnis ratione aut voluptas sint nam galisum adipisci? Sed vitae quia At rerum itaque et rerum similique e a voluptatum optio rem assumenda error.',
      local: 'Av. da Lamedas SP - São Paulo',
    ),
    DummyModel(
      course: 'Python',
      description:
